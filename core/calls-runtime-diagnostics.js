...
(function(w){
  ...
  function agoraRuntime(){ var ace = w.AgoraCallEngine; return { available: !!ace, hasAgoraRTC: !!w.AgoraRTC, isJoined: hasFn(ace,'isJoined') ? safe(function(){ return ace.isJoined(); }, false) : false, isMuted: hasFn(ace,'isMuted') ? safe(function(){ return ace.isMuted(); }, false) : false, currentChannel: hasFn(ace,'currentChannel') ? safe(function(){ return ace.currentChannel(); }, null) : null }; }
