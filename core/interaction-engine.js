...
(function(){
  ...
  const TYPE_META = {
    ...
    CALL_RECEIVED:    { obd: 'CALL_RECEIVED',          flow: 'FLOW-CALL-REQUEST',   invariants: ['INV-COM-003'] },
  ...
  function getAnalytics(plate) {
    ...
    return {
      ...
      total_calls:    (by_type.CALL||0) + (by_type.CALL_REQUEST||0) + (by_type.CALL_RECEIVED||0) + (by_type.CALL_ACCEPTED||0) + (by_type.CALL_REFUSED||0) + (by_type.CALL_MISSED||0) + (by_type.CALL_CANCELLED||0),
