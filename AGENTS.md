...
```
SESSION-CONTINUATION.md est la source officielle de vérité.
Aucun autre fichier ne remplace SESSION-CONTINUATION.md comme point de départ.
Un fichier de diagnostic, d'audit ou de roadmap est une annexe — jamais un point d'entrée.
```
