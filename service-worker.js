...
const CACHE_NAME  = 'immatconnect-pro-v455';
...
const STATIC_CACHE = [
  ...
  './core/interaction-engine.js?v=7',
  ...
  './core/audio-manager.js?v=9',
  './core/call-screen.js?v=10',
  './core/call-notification-runtime.js?v=2',
  ...
  './core/narrator.js?v=9',
  './core/swarm-engine.js?v=1',
  './core/immat-consciousness.js?v=2',
  './core/immat-soul.js?v=1',
  './core/immat-kernel.js?v=1',
  './core/immat-copilot.js?v=8',
  './core/immat-test-engine.js?v=2',
  './core/gardien-diagnostic.js?v=3',
  './core/immat-nexus.js?v=14',
  './audio/ange-ecoute.wav?v=3',
  './audio/ange-oui.wav?v=3',
  './audio/ange-fait.wav?v=3',
  './audio/ange-envoye.wav?v=3',
  './audio/ange-annule.wav?v=3',
  './audio/ange-repete.wav?v=3',
  './audio/ange-message.wav?v=3',
  './audio/ange-arret.wav?v=3',
  './audio/ange-instable.wav?v=3',
  './audio/ange-horsligne.wav?v=3',
];
