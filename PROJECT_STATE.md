...
| **`docs/ADR-DASHBOARD-V2.md`** | ADR figé — refonte Dashboard Gardien en écran de gouvernance + registre data-driven unique (7 invariants INV-DASH, portée device/account/fleet, cycle de vie, migration 6 étapes) | Avant tout travail sur le Dashboard, les Feature Flags ou les diagnostics |
