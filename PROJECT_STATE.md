...
SW                     : v323 · app.css v60 · messages.js v39 · messages.css v7 · calls.js v22 · audio-manager.js v9 · ui.js v15
...
| Date | Auteur | Résumé |
|---|---|---|
| 2026-06-28 | IA session | Signaler/Véhicule : numéros d'urgence 15/17/18 déplacés en bas de l'étape + compactés (étaient en haut, trop gros). Étapes Aide/Stationné inchangées. SW v323. Commit 992c7d1. |
