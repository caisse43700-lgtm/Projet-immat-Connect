...
function loadKnowledge() {
  ...
  const knownObserveEvents = new Set([
    ...
    // §3 Messagerie — OBD-003d
    'CONV_UNARCHIVE', 'CONV_UNFAVORITE',
    'MESSAGE_READ', 'MESSAGE_UNREAD', 'MESSAGE_RETRY', 'MESSAGE_SYNCED',
    'MESSAGE_DELETED_LOCAL', 'MESSAGE_REPORTED',
    'MESSAGE_FROM_ALERT', 'MESSAGE_FROM_CONTEXT', 'MESSAGE_FROM_CALL',
    'QUICK_REPLY_USED', 'THREAD_RESTORED', 'THREAD_REFRESH', 'UNREAD_BADGE_UPDATED',
    // §4 Appels — OBD-003d
    'CALL_TIMEOUT', 'CALL_CONNECTED', 'CALL_INTERRUPTED',
    'CALL_NETWORK_LOST', 'CALL_RECONNECTED', 'CALL_PERMISSION_DENIED',
    'CALL_TRUSTED', 'CALL_EMERGENCY',
    'CALL_FROM_ALERT', 'CALL_FROM_MESSAGE', 'CALL_FROM_PROXIMITY_SIGNAL',
  ]);
